...
class CellXform extends BaseXform {
    ...
    switch (node.name) {
      case 'c':
        ...
        if (node.attributes.s) {
          this.model.styleId = Number.parseInt(node.attributes.s, 10);
        }
        return true;
        ...
        if (model.formula || model.shareType) {
          ...
          if (model.value) {
            if (this.t === 'str') {
              ...
              model.result = Number.parseInt(model.value, 10) !== 0;
            } else if (this.t === 'e') {
              model.result = { error: model.value };
            } else {
              model.result = Number.parseFloat(model.value);
            }
          ...
          switch (this.t) {
            case 's':
              ...
              model.value = Number.parseInt(model.value, 10);
              break;
            case 'str':
              model.type = Enums.ValueType.String;
            ...
            case 'b':
              ...
              model.value = Number.parseInt(model.value, 10) !== 0;
              break;
            case 'e':
            ...
            default:
              ...
              model.value = Number.parseFloat(model.value);
              break;
          }
  ...
  reconcile(model, options) {
    ...
    const comment = options.commentsMap?.[model.address];
    if (comment) {
