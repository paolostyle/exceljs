  ...
  render(xmlStream, model) {
    if (model) {
      const attributes = {
        ...
        selectUnlockedCells:
          model.selectUnlockedCells === false ? '1' : undefined,
    ...
    switch (node.name) {
      case this.tag:
        this.model = {
          ...
          selectLockedCells:
            node.attributes.selectLockedCells === '1' ? false : undefined,
          selectUnlockedCells:
            node.attributes.selectUnlockedCells === '1' ? false : undefined,
        ...
        if (node.attributes.algorithmName) {
          ...
          this.model.spinCount = Number.parseInt(node.attributes.spinCount, 10);
        }
        return true;
      default:
        return false;
