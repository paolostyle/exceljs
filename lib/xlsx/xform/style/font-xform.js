...
class FontXform extends BaseXform {
  constructor(options) {
    ...
    this.map = {
      ...
      charset: {
        prop: 'charset',
        xform: new IntegerXform({ tag: 'charset', attr: 'val' }),
      },
      ...
      extend: {
        prop: 'extend',
        xform: new BooleanXform({ tag: 'extend', attr: 'val' }),
      },
      family: {
        prop: 'family',
        xform: new IntegerXform({ tag: 'family', attr: 'val' }),
      },
      outline: {
        prop: 'outline',
        xform: new BooleanXform({ tag: 'outline', attr: 'val' }),
      },
      vertAlign: {
        prop: 'vertAlign',
      ...
      scheme: {
        prop: 'scheme',
        xform: new StringXform({ tag: 'scheme', attr: 'val' }),
      },
      shadow: {
        prop: 'shadow',
        xform: new BooleanXform({ tag: 'shadow', attr: 'val' }),
      },
      strike: {
        prop: 'strike',
        xform: new BooleanXform({ tag: 'strike', attr: 'val' }),
      },
